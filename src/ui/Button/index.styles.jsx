...
//     background-color: ${(disabled && GREY[200]) ||
...
const Wrapper = styled('button')(({size, disabled, ButtonTheme, width}) => `
  width: ${width};
  font-size: ${{
  large: '1.2rem',
  medium: '1rem',
  ...
  ${
    ...
    `
      &:hover {
        background-color: ${
        {
          primary: INDIGO_MUTED,
          secondary: MUSTARD_MUTED,
          tertiary: WHITE,
        }[ButtonTheme]
    };
        color: ${
        ButtonTheme === 'tertiary' ? GREY[600] : null
    };
      }`
}
`);
...
//       &:hover {
//         background-color: ${
//         { primary: INDIGO_MUTED, secondary: MUSTARD_MUTED, tertiary: WHITE }[            buttonTheme          ]
//     };
//         color: ${buttonTheme === "tertiary" ? GREY[600] : null};
//       }`}
//
